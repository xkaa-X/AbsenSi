...
<div class="row justify-content-center">
    <div class="col-12 col-lg-8 col-xl-7">
        <div class="card p-4">
            <h4 class="fw-bold mb-1">Perbarui Jurusan</h4>
            <p class="text-muted">Ubah rincian informasi untuk memperbarui data jurusan.</p>
            ...
            <form action="{{ route('jurusan.update', $jurusan->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control form-control-premium @error('nama_jurusan') is-invalid @enderror" 
                           id="nama_jurusan" name="nama_jurusan" value="{{ old('nama_jurusan', $jurusan->nama_jurusan) }}" 
                ...
                <div class="d-flex justify-content-end gap-2 mt-5">
                    ...
                    <button type="submit" class="btn btn-premium-primary px-4">
                        <i class="bi bi-check2-all me-1"></i> Perbarui Jurusan
                    </button>
                </div>
            </form>
        </div>
