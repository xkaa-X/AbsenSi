...
<div class="row justify-content-center">
    <div class="col-12 col-lg-8 col-xl-7">
        <div class="card p-4">
            <h4 class="fw-bold mb-1">Perbarui Profil Siswa</h4>
            <p class="text-muted">Ubah rincian informasi untuk memperbarui data siswa.</p>
            ...
            <form action="{{ route('siswa.update', $siswa->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control form-control-premium @error('alamat') is-invalid @enderror" 
                              ...
                              placeholder="Contoh: Jl. Kebon Jeruk No. 12, Jakarta" required>{{ old('alamat', $siswa->alamat) }}</textarea>
                    @error('alamat')
                        <div class="invalid-feedback fw-semibold">{{ $message }}</div>
                    @enderror
                </div>
